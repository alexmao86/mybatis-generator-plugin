...
public class MapperDecoratorPlugin extends PluginAdapter {
    ...
    public boolean modelExampleClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        while (propNames.hasMoreElements()) {
            ...
            String capitalizedPropName = propName.substring(0, 1).toUpperCase()+ propName.substring(1);
    ...
    private Method generateDecoratedProviderMethod(Method method, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        StringBuilder sb = new StringBuilder("String sql = ").append("this.").append(method.getName()).append("(");
        for (Parameter p : params) {
            sb.append(p.getName());
            sb.append(",");
        }
    ...
    private static class Config extends BasePluginConfig {
        ...
        private Config(Properties props) {
            ...
            if (methodToGenerateName == null)
                throw new IllegalStateException("Property '" + methodToGenerateKey + "' should be specified for plugin " + this.getClass().getName());

            methodToDecorateName = props.getProperty(methodToDecorateKey);
            if (methodToDecorateName == null)
                throw new IllegalStateException("Property '" + methodToDecorateKey + "' should be specified for plugin "  + this.getClass().getName());

            sql = props.getProperty(sqlKey);
            if (sql == null)
                throw new IllegalStateException("Property '" + sqlKey + "' should be specified for plugin " + this.getClass().getName());
        }
