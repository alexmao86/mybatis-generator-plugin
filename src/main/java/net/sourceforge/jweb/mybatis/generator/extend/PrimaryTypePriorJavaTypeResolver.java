package net.sourceforge.jweb.mybatis.generator.extend;
/*
...
/**
 * 
 * This is on JavaTypeResolver for mybatis generator, it use primary type first for pojo
 * @author maoanapex88@163.com
 *
 */
public class PrimaryTypePriorJavaTypeResolver implements JavaTypeResolver {
    ...
    public PrimaryTypePriorJavaTypeResolver() {
        super();
        ...
        typeMap.put(Types.BIT, new JdbcTypeInformation("BIT",  new FullyQualifiedJavaType("boolean")));
        typeMap.put(Types.BLOB, new JdbcTypeInformation("BLOB",  new FullyQualifiedJavaType("byte[]"))); 
        typeMap.put(Types.BOOLEAN, new JdbcTypeInformation("BOOLEAN",  new FullyQualifiedJavaType("boolean")));
        ...
        typeMap.put(Types.FLOAT, new JdbcTypeInformation("FLOAT", new FullyQualifiedJavaType("float")));
