			...
			if(generateSelectOneWithBLOBs){
				...
				if(nodeObj!=null){
					...
					if(nodes.getLength()!=1){
						...
						document.getRootElement().addElement(PluginUtil.cloneElement(selectEl, config.methodToGenerate+"WithBLOBs"));
					}
				}
	    	}
	    	if(generateSelectOneWithoutBLOBs){
				...
				if(nodeObj!=null){
					...
					if(nodes.getLength()!=1){
						...
						Element selectEl=(Element)nodes.item(0);
						document.getRootElement().addElement(new TextElement("<!-- generated by SelectOneByExamplePlugin "+new Date()+" -->"));
						document.getRootElement().addElement(PluginUtil.cloneElement(selectEl, config.methodToGenerate));
					}
				}
	    	}
		} catch (Exception e) {
